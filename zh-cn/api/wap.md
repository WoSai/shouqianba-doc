...
具体请参考收钱吧支付网关[预下单接口文档](https://book.shouqianba.com/shouqianba-doc/content/zh-cn/api/interface/precreate.html)
...
具体请参考收钱吧支付网关[查询接口文档](https://doc.shouqianba.com/zh-cn/api/interface/query.html)
