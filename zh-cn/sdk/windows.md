...
输出参数|**激活、支付、预下单、退款、撤单接口**:返回状态<font color=#B22222>.</font>返回信息(&符号连接)<br>**查询接口(query)**:返回状态<font color=#B22222>:</font>返回信息(json 格式)<br>**查询接口(queryEx)**:返回状态<font color=#B22222>:</font>返回信息(&符号连接)<br>例：<br>Pay Success.参数 1&参数 2&...&参数 n<br>Query Result:{param1=”1”, param1=”2”}<br>**扩展接口**:单一返回值
