...
## 1. 申请接入资格
```
 联系负责对接的收钱吧商务，沟通洽谈，根据各自的需求选择合适的入网方式和支付接入方式，并建立合作关系。
```

## 2. 选择入网接入方式
```
 收钱吧入网平台提供通过入网体系，以及对接入网接口的两种方式，
 通过入网体系进行商户入网的，参考步骤6，
 通过对接商户入网接口入网的，请参考Web API接入指南-》商户入网Open API
```

## 3. 根据场景选择支付接入方式
```
  收钱吧支付平台提供Web API,SDK,WAP API PRO,WebProxy接入四种方式,
...
```
## 5. 提交服务商资料,获取[服务商平台](http://op.shouqianba.com)登录账号和密码
```
开通服务商所需要的信息如下:
...
``` 
## 6.提交商户资料，获取[商户平台](http://s.shouqianba.com)登录账号和密码
```
